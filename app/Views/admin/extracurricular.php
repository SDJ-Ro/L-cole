...
<head>
  ...
  <title>Extracurricular — L'École Admin</title>
  ...
  <main class="c-main" id="j-main">
    <div class="c-page-stack">
      ...
      <div id="j-view-club-detail" style="display: none;" data-clubs="<?= htmlspecialchars(json_encode($clubs ?? []), ENT_QUOTES, 'UTF-8') ?>">
        ...
        $calendarConfig = [
            ...
            'events'       => [
                ...
                [
                    ...
                    'date'     => '2026-06-24',
                    'time'     => '14:00–18:00',
                    'details'  => 'Official divisional match',
                    'category' => 'Extracurricular'
                ]
            ],
        ];
        ...
        <!-- Teams & Roster Section (Admin/Teacher/Management only) -->
        <?php
        $canEdit   = !empty($canCreate);
        $canDelete = !empty($canCreate); // Admin can delete
