...
<head>
  ...
  <title>Notice Board — L'École Parent Portal</title>
...
<div id="j-app-root" class="c-app-shell">
  ...
  <main class="c-main" id="j-main">
    ...
    <div class="c-page-stack" id="j-view-board">
      ...
      <!-- Page Header (Read-only for Parents) -->
      <?php
      $pageTitle    = 'Notice Board';
      $pageSubtitle = 'Stay up to date with announcements across all your child’s academic programmes.';
      $actionButton = '';
