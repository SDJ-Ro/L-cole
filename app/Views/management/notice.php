...
<head>
  ...
  <title>Notice Board — L'École Management</title>
...
<!-- Expose CSRF token and API endpoint URLs to JavaScript -->
<script>
  window.LECOLE_NOTICE = {
    csrfToken:    <?= json_encode($csrf_token ?? '') ?>,
    saveUrl:      '/notice/save-notice',
    deleteUrl:    '/notice/delete-notice',
    togglePinUrl: '/notice/toggle-pin-notice'
  };
</script>
...
<div id="j-app-root" class="c-app-shell">
  ...
  <main class="c-main" id="j-main">
    ...
    <div class="c-page-stack" id="j-view-board">
      ...
      $pageSubtitle = 'Institutional announcements, administrative circulars, and official directives.';
      $actionButton = '
